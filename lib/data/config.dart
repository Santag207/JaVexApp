// ============================================================
// CONFIGURACIÓN DEL MOCK SERVER (legacy / fallback)
// ============================================================
// Solo se usa si se vuelve a registrar DioApiService en el
// service_locator. Para correr con el mock server:
...
class ApiConfig {
  static const String baseUrl = 'http://192.168.2.51:3000';
}
